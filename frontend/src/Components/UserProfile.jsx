    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4 sm:p-8">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium text-base sm:text-lg">Loading your profile...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 flex items-center justify-center p-4 sm:p-8">
        ...
        <div className="text-center bg-white rounded-3xl p-6 sm:p-12 shadow-2xl border border-gray-100 max-w-md w-full mx-4">
          ...
          <h3 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2 sm:mb-3">Profile Not Found</h3>
          <p className="text-gray-600 mb-6 sm:mb-8 text-sm sm:text-lg">Unable to load your profile information</p>
          <button 
            ...
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl shadow-blue-500/10 border border-gray-100 overflow-hidden">
              ...
              <div className="relative h-32 sm:h-40 lg:h-48 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700">
                ...
                <div className="absolute -bottom-6 sm:-bottom-8 lg:-bottom-12 left-4 sm:left-6">
                  <div className="relative group">
                    ...
                    >
                      <Camera size={12} className="sm:w-4 sm:h-4 lg:w-5 lg:h-5" />
                    </button>
                  </div>
                </div>
              </div>
              ...
              <div className="pt-12 sm:pt-14 lg:pt-16 p-4 sm:p-6 lg:p-8">
                ...
                <div className="text-center mb-4 sm:mb-6">
                  <h2 className="text-xl sm:text-2xl lg:text-2xl font-bold text-gray-900 mb-1 sm:mb-2">{profile.name}</h2>
                  <div className="flex items-center justify-center space-x-3 sm:space-x-4 text-gray-600 text-sm sm:text-base">
                    <div className="flex items-center space-x-1">
                      ...
                      <span className="font-medium">{profile.age || "N/A"} years</span>
                    </div>
                    <div className="flex items-center space-x-1">
                ...
                <div className="text-center mb-6 sm:mb-8">
                  <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-purple-100 text-blue-700 px-3 sm:px-4 lg:px-5 py-1.5 sm:py-2 lg:py-2.5 rounded-full text-xs sm:text-sm font-semibold">
                    <Briefcase size={14} className="sm:w-4 sm:h-4 lg:w-5 lg:h-5" />
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 mb-6 sm:mb-8">
                  <div className="text-center p-3 sm:p-4 bg-blue-50 rounded-xl sm:rounded-2xl">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-600 mb-1">0</div>
                  ...
                  <div className="text-center p-3 sm:p-4 bg-purple-50 rounded-xl sm:rounded-2xl">
                    <div className="text-lg sm:text-xl lg:text-2xl font-bold text-purple-600 mb-1">0</div>
                  ...
                  {profile.isCompleted !== undefined && (
                    <div className={`flex items-center justify-between p-3 sm:p-4 rounded-xl sm:rounded-2xl ${
                      ...
                      <div className="flex items-center gap-2 sm:gap-3">
                        <div className={`w-2 h-2 sm:w-3 sm:h-3 rounded-full ${profile.isCompleted ? 'bg-green-500' : 'bg-yellow-500'}`}></div>
                        <span className={`font-semibold text-xs sm:text-sm ${profile.isCompleted ? 'text-green-700' : 'text-yellow-700'}`}>
                          Profile {profile.isCompleted ? 'Complete' : 'Incomplete'}
                        </span>
                      </div>
                      <Star size={14} className={`sm:w-4 sm:h-4 ${profile.isCompleted ? 'text-green-500' : 'text-yellow-500'}`} />
                    </div>
                  )}
                ...
                >
                  ...
                  <ChevronRight size={16} className="sm:w-5 sm:h-5 group-hover:translate-x-1 transition-transform duration-300" />
                </motion.button>
              </div>
            </div>
          </div>
              ...
              <div className="md:col-span-2 bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl shadow-blue-500/10 border border-gray-100 p-4 sm:p-6 lg:p-8">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                  <div className="bg-blue-100 p-1.5 sm:p-2 rounded-lg sm:rounded-xl">
                    <Mail className="text-blue-600" size={18} className="sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
                  </div>
                  Contact Information
                </h3>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 lg:gap-6">
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl hover:bg-blue-50 transition-all duration-300">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="font-semibold text-gray-900 truncate text-sm sm:text-base">{getUserEmail()}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl hover:bg-blue-50 transition-all duration-300">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="font-semibold text-gray-900 text-sm sm:text-base">{getUserLocation()}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl hover:bg-blue-50 transition-all duration-300">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="font-semibold text-gray-900 text-sm sm:text-base">{profile.phone || "Not provided"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl hover:bg-blue-50 transition-all duration-300">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-gray-500 mb-1">Mother Tongue</p>
                      <p className="font-semibold text-gray-900 text-sm sm:text-base">{profile.motherTongue || "Not specified"}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl shadow-blue-500/10 border border-gray-100 p-4 sm:p-6 lg:p-8">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                  <div className="bg-green-100 p-1.5 sm:p-2 rounded-lg sm:rounded-xl">
                    <User className="text-green-600" size={18} className="sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
                  </div>
                  Personal Details
                </h3>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  {profile.height && (
                    <div className="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl">
                      <span className="text-gray-600 font-medium text-sm sm:text-base">Height</span>
                      <span className="font-semibold text-gray-900 text-sm sm:text-base">{profile.height}</span>
                    </div>
                  )}
                  ...
                  {profile.religion && (
                    <div className="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl">
                      <span className="text-gray-600 font-medium text-sm sm:text-base">Religion</span>
                      <span className="font-semibold text-gray-900 text-sm sm:text-base">{profile.religion}</span>
                    </div>
                  )}
                  ...
                  {profile.maritalStatus && (
                    <div className="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl">
                      <span className="text-gray-600 font-medium text-sm sm:text-base">Marital Status</span>
                      <span className="font-semibold text-gray-900 text-sm sm:text-base capitalize">{profile.maritalStatus}</span>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl shadow-blue-500/10 border border-gray-100 p-4 sm:p-6 lg:p-8">
                <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                  <div className="bg-purple-100 p-1.5 sm:p-2 rounded-lg sm:rounded-xl">
                    <Briefcase className="text-purple-600" size={18} className="sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
                  </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  {profile.education && (
                    <div className="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl">
                      <span className="text-gray-600 font-medium text-sm sm:text-base">Education</span>
                      <span className="font-semibold text-gray-900 text-sm sm:text-base">{profile.education}</span>
                    </div>
                  )}
                  ...
                  {profile.occupation && (
                    <div className="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl">
                      <span className="text-gray-600 font-medium text-sm sm:text-base">Occupation</span>
                      <span className="font-semibold text-gray-900 text-sm sm:text-base">{profile.occupation}</span>
                    </div>
                  )}
                  ...
                  {profile.income && (
                    <div className="flex justify-between items-center p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl">
                      <span className="text-gray-600 font-medium text-sm sm:text-base">Annual Income</span>
                      <span className="font-semibold text-gray-900 text-sm sm:text-base">{profile.income}</span>
                    </div>
                  )}
                  ...
                  {profile.familyBackground && (
                    <div className="p-3 sm:p-4 bg-gray-50 rounded-xl sm:rounded-2xl">
                      <span className="text-gray-600 font-medium text-sm sm:text-base block mb-2">Family Background</span>
                      <span className="font-semibold text-gray-900 text-sm sm:text-base">{profile.familyBackground}</span>
                    </div>
                  )}
                </div>
              </div>
                ...
                <div className="md:col-span-2 bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-2xl shadow-blue-500/10 border border-gray-100 p-4 sm:p-6 lg:p-8">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center gap-2 sm:gap-3">
                    <div className="bg-indigo-100 p-1.5 sm:p-2 rounded-lg sm:rounded-xl">
                      <Globe className="text-indigo-600" size={18} className="sm:w-5 sm:h-5 lg:w-6 lg:h-6" />
                    </div>
                    About Me
                  </h3>

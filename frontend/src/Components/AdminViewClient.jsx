    ...
    <div className="min-h-screen bg-gray-100 px-3 sm:px-6 py-6">
      ...
      <div className="max-w-6xl mx-auto bg-white shadow rounded-xl overflow-hidden">
        ...
        <div className="p-4 sm:p-6 space-y-6">
          ...
          {activeTab === "lifestyle" && (
            <TabSection title="">
              <Field label="Relationship Status" value={profile.relationshipStatus} />
              <Field label="Country" value={profile.country} />
              <Field label="City" value={profile.city} />
              <Field label="Education" value={profile.education} />
              <Field label="Professional Status" value={profile.professionalStatus} />
          ...
          {activeTab === "partner" && (
            <TabSection title="">
              <Field label="Interested In" value={profile.partnerPreferences?.interestedIn} />
              <Field label="Height Range" value={profile.partnerPreferences?.heightRange} />
              <Field label="Weight Range" value={profile.partnerPreferences?.weightRange} />
              <Field label="Relationship Status" value={profile.partnerPreferences?.relationshipStatus} />
              <Field label="Alcohol" value={profile.partnerPreferences?.alcohol} />
              <Field label="Smoking" value={profile.partnerPreferences?.smoking} />
              <Field label="Children" value={profile.partnerPreferences?.children} />
              <Field label="Country" value={profile.partnerPreferences?.country} />
              <Field label="Religion" value={profile.partnerPreferences?.religion} />
              <Field label="Language" value={profile.partnerPreferences?.language} />
              <Field label="Education" value={profile.partnerPreferences?.education} />
              <Field label="Age Min" value={profile.partnerPreferences?.ageMin} />
              <Field label="Age Max" value={profile.partnerPreferences?.ageMax} />
              <Field
...
function Field({ label, value, full }) {
  return (
    <p className={`text-sm sm:text-base text-gray-700 ${full ? "sm:col-span-2" : ""}`}>
